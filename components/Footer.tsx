...
function Footer() {
  return (
    <footer className="bg-cover bg-no-repeat bg-[url('/backgrounds/sl1.jpg')] bg-gray-400 bg-blend-multiply">
        <div className="p-4 font-[sans-serif] py-16 ">
            <div className="max-w-screen-xl mx-auto bg-[#173567] bg-opacity-60 border border-[#173567] p-8">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div className="lg:flex lg:items-center">
                        <a href="javascript:void(0)">
                        <img src="/logos/lg-1.png" alt="logo" className="w-24" />
                        </a>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 pl-2">
                            ...
                            <li>
                                <a href="javascript:void(0)" className="text-gray-300 hover:text-white text-sm">Properties</a>
                            </li>
                            <li>
                                <a href="javascript:void(0)" className="text-gray-300 hover:text-white text-sm">Contact Us</a>
                            </li>
                        </ul>
                    </div>
