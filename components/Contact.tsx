...
const Contact = () => {
     ...
     const imgy = width && width > 640 ? '/backgrounds/desks/d2.png' : '/backgrounds/h4.jpeg';
  return (
    <div className="mx-auto bg-cover bg-no-repeat bg-gray-400 md:bg-gray-50 bg-blend-multiply" style={{backgroundImage: "url(" + imgy + ")"}}>
        <div className="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif] py-16 max-w-6xl mx-auto">
            <div>
                ...
                <p className="text-sm text-gray-300 mt-4 leading-relaxed">Ready to invest in Dubai? Contact us today for expert guidance and seamless property solutions!</p>
            ...
            <div className="bg-gray-100 p-6 rounded-lg">
                ...
                <div className="space-y-4 max-lg:mt-4">
                    <button type="button" className="px-4 py-2 rounded-lg bg-[#173567] text-white text-sm tracking-wider font-medium outline-none border-2 border-[#173567] mr-4">Properties</button>
                    <button type="button" className="px-4 py-2 rounded-lg bg-transparent text-gray-800 text-sm tracking-wider font-medium outline-none border-2 border-gray-300 mr-4">Investments</button>
                    <button type="button" className="px-4 py-2 rounded-lg bg-transparent text-gray-800 text-sm tracking-wider font-medium outline-none border-2 border-gray-300">Relocation</button>
                </div>
